...
from ..utils.assets import BUTTON_ICON, BUTTON_FONT, CLICK_SOUND, WIN_SOUND
...
class Button:
    ...
    """
    def __init__(self, x_pos, y_pos, image, text_input, button_size):
        # self.image = pygame.transform.scale(BUTTON_ICON, button_size)  # Button graphic
        self.image = pygame.transform.scale(image, button_size)
        self.x_pos = x_pos
        self.y_pos = y_pos
    ...
    def handle_event(self, event, button_type, sound_on=True):
        """
        ...
        if event.type == pygame.MOUSEMOTION:
            ...
            if self.hovered:
                if sound_on and CLICK_SOUND:
                    CLICK_SOUND.play()
                if button_type in ["confirm", "cancel", "sound", "music", "close", "agree", "home", "replay"]:
                    return True
                match button_type:
                    case "mode":
                    ...
                    case "setting":
                        return self.handle_setting_event()
